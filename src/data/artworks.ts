...
​A warm, live-edge wood top sits above it all, like a steady horizon line.`,
    images: [
      ...
      im("between-day-and-night/03-left", "Left view", "Between Day and Night, console by Simpy Bansal — left view", 1333, 2000),
      im("between-day-and-night/04-right", "Right view", "Between Day and Night, console by Simpy Bansal — right view", 1333, 2000),
      im("between-day-and-night/05-left-back", "Back left view", "Between Day and Night, console by Simpy Bansal — back left view", 1333, 2000),
      im("between-day-and-night/06-right-back", "Back right view", "Between Day and Night, console by Simpy Bansal — back right view", 1333, 2000),
    ],
  },
  {
    ...
    dimensions: "48” width × 37” height × 18” depth",
    status: "Available",
...
A lotus pond floats beneath a softly curved wooden arch. For me, this console is not just furniture; it is a feeling , a moment of calm, and quiet brought into a space.`,
  ...
  },
  {
    ...
    year: "2026",
    medium: "Acrylic painting on canvas with a wooden base of functional art having a top of sawn live edge",
    dimensions: "48” width × 31” height × 20” depth",
    status: "Available",
    ...
    images: [
      ...
      im("the-midnight-tide/02-front", "Full view", "The Midnight Tide, console by Simpy Bansal — full view", 2000, 1333),
      im("the-midnight-tide/03-back", "Back view", "The Midnight Tide, console by Simpy Bansal — back view", 1493, 2000),
      im("the-midnight-tide/04-top", "Top view", "The Midnight Tide, console by Simpy Bansal — top view", 2000, 1333),
      im("the-midnight-tide/05-side", "Side view", "The Midnight Tide, console by Simpy Bansal — side view", 1333, 2000),
    ],
  },
  {
...
From selecting the perfect piece of timber to painting every leaf and feather by hand, this piece was a true labor of love. The idea of perching guided the entire design. The birds do not merely appear on the doors; they feel as though they are resting on the furniture itself. Even the custom hardware dissolves into the branches, completing a scene that feels alive, grounded, and quietly poetic.`,
  ...
  },
  {
    ...
    status: "Available",
    blurb: "Where branches wander and blossoms bloom, like bringing a touch of sunshine, warmth, and wonder into the room An invitation to bring the outdoors in.",
...
From selecting the perfect piece of timber to painting every leaf and branch by hand, this piece was a true labor of love. The idea of blooming guided the entire design. Even the custom hardware dissolves into the branches, completing a scene that feels grounded, and quietly poetic.`,
    images: [
      ...
      im("the-summer-bloom/01-front", "Full view", "The Summer Bloom, console by Simpy Bansal — full view", 1586, 1006),
  ...
  },
  {
    ...
    dimensions: "40” width × 70” height × 18” depth",
    status: "Available",
  ...
  },
  {
    ...
    dimensions: "24” width × 36” height × 1” depth",
    status: "Available",
  ...
  },
  {
    ...
    discipline: "Ceramic",
    year: "2012",
    medium: "Ceramic Acrylic painting on wood",
    dimensions: "20” width × 26” height × 1.5” depth",
    status: "Sold",
    blurb: "A painting celebrating cultural beauty and is a reminder of the simplicity and tranquility",
    oneLiner: "A gentle gaze and a timeless grace,",
    description: "A Mughal princess captured in a moment of quiet grace—her delicate expression and flowing details reflecting the softness, elegance, and timeless beauty of a bygone era. Gentle Touch is a celebration of femininity expressed through subtlety and serenity.",
    images: [
      im("a-gentle-touch/00-front", "Full view", "A Gentle Touch, ceramic by Simpy Bansal — full view", 1305, 1600),
    ],
  },
  {
  ...
  },
  {
    ...
    year: "2015",
    medium: "Ceramic Acrylic painting on wood",
    dimensions: "26“ width × 20” height × 1.5” depth",
    status: "Sold",
...
And now, as the lotuses have started blooming, I feel that same joy I felt as a child. Without even planning it, I find myself painting lotuses again and again. It feels like something has come full circle—and through my art, I’m staying connected to that memory`,
    images: [
      ...
      im("full-circle/01-front", "Full view", "Full Circle, ceramic by Simpy Bansal — full view", 1200, 2000),
    ],
  },
  {
    slug: "the-divine",
...
This tree is my way of honoring every part of my journey, how beautifully colorful life really is, even with its ups and downs.`,
    images: [
      ...
      im("the-divine/01-front", "Full view", "The Divine, ceramic by Simpy Bansal — full view", 1333, 2000),
      im("the-divine/02-left", "Left view", "The Divine, ceramic by Simpy Bansal — left view", 1333, 2000),
      im("the-divine/03-right", "Right view", "The Divine, ceramic by Simpy Bansal — right view", 1333, 2000),
    ],
  },
  {
    slug: "tree-of-life",
    ...
    discipline: "Ceramic",
    year: "2023",
    medium: "Ceramic Acrylic 3D painting",
    dimensions: "48” width × 96” height × 3” depth",
    status: "Sold",
...
Through the textures, ripples and raised lotus details, I tried to recreate the feeling of being right there on the water, gently rowing through a beautiful lotus pond.`,
    images: [
      ...
      im("whispering-lake/01-front", "Full view", "Whispering Lake, ceramic by Simpy Bansal — full view", 950, 1340),
    ],
  },
  {
...
For me, this piece is my celebration of colour, light, and the effortless beauty of nature.`,
    images: [
      ...
      im("feathers-of-color/01-front", "Full view", "Feathers of Color, glass by Simpy Bansal — full view", 1471, 2000),
    ],
  },
  {
  ...
  },
  {
    ...
    dimensions: "16” width × 19” Height × 1” depth",
    status: "Available",
...
Just as glass reflects what stands before it, relationships reflect understanding, togetherness, and the beauty of finding a connection.`,
  ...
  },
  {
    ...
    discipline: "Glass",
    year: "2014",
    medium: "Stain glass painting",
    dimensions: "20” width × 26” height × 1” depth",
    status: "Sold",
...
I don’t own one, but every time I see one on the road or in an old photo, it makes me pause and smile. Painting the vintage collection on glass was like capturing a piece of history and keeping it close.`,
  ...
  },
  {
    ...
    year: "2025",
    medium: "Soft Pastel on Paper in a wooden frame",
    dimensions: "17.5” width × 24.5” height × 1” depth",
    status: "Sold",
  ...
  },
  {
    ...
    oneLiner: "beauty speaks without a sound",
...
Using soft pastels, I tried to reflect a sense of calm and stillness—like that quiet moment just before the peacock opens its feathers.`,
  ...
  },
  {
    ...
    year: "2026",
    medium: "Acrylic ceramic painting on wood",
    dimensions: "12” width × 19” height × 12” depth",
    status: "Available",
...
It is functional, but at the same time, it is a piece of art created to bring color, character, and a little joy into a space.`,
    images: [
      ...
      im("rhythm-of-color/01-front", "Full view", "Rhythm of Color, sculpture by Simpy Bansal — full view", 2000, 2000),
      im("rhythm-of-color/02-top", "Top view", "Rhythm of Color, sculpture by Simpy Bansal — top view", 2000, 2000),
      im("rhythm-of-color/03-side", "Side view", "Rhythm of Color, sculpture by Simpy Bansal — side view", 2000, 2000),
    ],
  },
  {
    slug: "the-core",
    ...
    dimensions: "14” width × 24.5” height × 13” depth",
    status: "Available",
...
For me, that is how life feels too. What we see on the outside is shaped by everything we have experienced within us. The happy moments, the difficult ones, the people we have met, the lessons we have learned. All of them become part of who we are.`,
  ...
  },
  {
    ...
    year: "2026",
    medium: "Acrylic ceramic on wood",
    dimensions: "15” width × 25” height × 15” depth",
    status: "Available",
